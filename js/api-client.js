...
const ApiClient = (() => {
  ...
  return {
    ...
    draftCrear:         (payload) => _request('draft_crear',         { method: 'POST', body: payload }),
    draftItemsAdd:      (payload) => _request('draft_items_add',     { method: 'POST', body: payload }),
    draftItemUpdate:    (payload) => _request('draft_item_update',   { method: 'POST', body: payload }),
    draftItemRemove:    (transfer_id, row_id) => _request('draft_item_remove', { query: { transfer_id, row_id } }),
    draftEnviar:        (payload) => _request('draft_enviar',        { method: 'POST', body: payload }),
    draftDescartar:     (transfer_id) => _request('draft_descartar', { query: { transfer_id } }),
    ...
    rutaActualizar:     (payload) => _request('ruta_actualizar', { method: 'POST', body: payload }),
    ...
    traspasoSalida:     (payload) => _request('traspaso_salida',     { method: 'POST', body: payload }),
